    ...
    return (
      <>
        <div className="w-full max-w-4xl mx-auto py-8 px-6">
          <div className="text-center justify-center item-center mb-8">
            <button className="flex mx-auto items-center justify-center px-4 py-2 border border-gray-300 bg-white text-gray-800 rounded-full shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-300">
              <svg className="w-5 h-5 mr-2 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path
                  fillRule="evenodd"
            ...
            <p className="text-gray-600 mt-2">Turbocharge your LLM apps development</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            <div className="border border-gray-200 p-6 rounded-lg ">
              <div className="flex items-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 24 24" className="w-6 h-6 text-gray-600" aria-hidden="true">
            ...
            <div className="border border-gray-200 p-6 rounded-lg ">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Accelerated prompt development</h3>
              </div>
              <p className="text-gray-600">Autogenerate your prompts and test examples. Compare selected prompts across models, parameters and prompt techniques.</p>
            </div>
            <div className="border border-gray-200 p-6 rounded-lg ">
              <div className="flex items-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 24 24" className="w-6 h-6 text-gray-600" aria-hidden="true">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Effortless deployment</h3>
              </div>
  
              <p className="text-gray-600">Integrate Pype SDK in 4 lines of code.</p>
            ...
            <div className="border border-gray-200 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Evaluate and Auto Optimize prompts</h3>
              </div>
              <p className="text-gray-600">Evaluate and pick the best performing prompt. Auto-Tune prompts to improve accuracy and consistency of the results.</p>
            ...
            <div className="border border-gray-200 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Monitor deployed prompts</h3>
              </div>
              <p className="text-gray-600">Robust observability tools provide real-time metrics— cost, latency, requests, accuracy and 10+ metrics.</p>
            ...
            <div className="border border-gray-200 p-6 rounded-lg ">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">No expertise required</h3>
              </div>
              <p className="text-gray-600">No need to learn 50+ prompting techniques to improve prompts.</p>
            </div>
          </div>
        </div>
      </>
