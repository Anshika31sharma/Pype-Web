      ...
      <>
        <div className="flex flex-col items-center p-6">
          ...
          <div className="flex gap-4 mb-8">
            <a href="https://app.pypeai.com/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 text-white py-2 px-4 rounded-md shadow-lg hover:bg-gray-700 transition-colors">
              Launch App
            </a>
            <a
              ...
              className="bg-blue-600 text-white py-2 px-4 rounded-md shadow-lg hover:bg-blue-500 transition-colors"
            >
              Book a demo →
            </a>
          </div>
          ...
          <div className="w-full bg-white py-6">
            <p className="text-center text-gray-600 mb-4">Helping individuals and teams at the world’s best companies</p>
